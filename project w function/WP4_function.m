function [Bit_rate,channel_gain_avg] = WP4_function(all_channel_gains,closest_sat_dists, CarrierFrequency)
...
for k = 1 : length(all_channel_gains)
    ...
    Bit_rate = Bit_rate + 1/N * (log2(1 + PRX(k)/(N0 * BW)));    
